...
const program = [
  {
    day: "День 1",
    title: "Что такое тестирование и кто такой QA Engineer",
    icon: BookOpen,
    desc: "Качество продукта, задачи и зона ответственности QA",
  },
  {
    day: "День 2",
    title: "Как создаются IT-продукты и как работает команда",
    icon: Users,
    desc: "Путь задачи от идеи до релиза и роль QA на каждом этапе",
  },
  {
    day: "День 3",
  ...
  {
    day: "День 12",
    title: "Как устроена работа QA в команде",
    icon: Briefcase,
    desc: "Agile, Scrum, Jira и взаимодействие с командой",
  },
  {
    day: "День 13",
    title: "Твой первый рабочий день QA",
    icon: FileText,
    desc: "Сквозная задача: проверки, баги, DevTools, API и SQL",
  },
  {
    day: "День 14",
