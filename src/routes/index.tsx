            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <Button asChild variant="outline" size="xl">
                <a href="https://vk.ru/qa_school" target="_blank" rel="noopener noreferrer">
                  <FaVk className="h-5 w-5 text-[#0077ff]" /> Записаться на курс
                </a>
              </Button>
            </div>
          </div>
      ...
      <section id="program" className="py-20 md:py-28 bg-[var(--gradient-soft)]">
        <div className="container-page">
          <SectionHead
            ...
            subtitle="Каждый день посвящён новой теме: понятная теория, примеры, интерактивные задания и небольшая практика. Двигайся последовательно, и через две недели соберётся полная картина профессии."
          />
