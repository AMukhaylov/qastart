...
const program = [
  ...
  },
  {
    ...
    title: "Тест-кейсы",
    icon: ClipboardCheck,
    desc: "Чек-листы и проверки",
  },
  {
    day: "День 4",
    title: "Баг-репорты",
    icon: Bug,
    desc: "Дефекты и приоритеты",
  },
  {
    day: "День 5",
    title: "Виды тестирования",
    icon: Layers,
    desc: "Smoke, Regression, UI",
  },
  {
    day: "День 6",
    title: "Тест-дизайн",
    icon: Sparkles,
    desc: "Классы и границы",
  },
  {
    day: "День 7",
    title: "Клиент и сервер",
    icon: Globe,
    desc: "Как работает приложение",
  },
  {
    day: "День 8",
    title: "DevTools",
    icon: Search,
    desc: "Elements, Console, Network",
  },
  {
    day: "День 9",
    title: "HTTP и API",
    icon: Code2,
    desc: "REST, JSON и статусы",
  },
  {
    day: "День 10",
    title: "Postman",
    icon: PlayCircle,
    desc: "Запросы и переменные",
  },
  {
    day: "День 11",
    title: "SQL",
    icon: Database,
    desc: "Запросы к данным",
  },
  {
    day: "День 12",
    title: "QA в команде",
