    ...
    <>
      ...
      >
        <LegalSection title="Какие данные мы получаем">
          <p>
            Мы обрабатываем данные, которые пользователь указывает при регистрации и обучении: имя,
            email, пароль в защищённом виде, ответы на домашние задания, комментарии, прикреплённые
            файлы и технические данные, необходимые для работы личного кабинета.
          </p>
        </LegalSection>
        <LegalSection title="Для чего используются данные">
          <p>
            ...
            наставника, восстановления доступа, технической поддержки и улучшения работы сервиса.
          </p>
        </LegalSection>
