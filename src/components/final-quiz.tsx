      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            В каждой попытке 30 случайных вопросов из банка 70 заданий. На прохождение даётся 30
            минут, правильные ответы откроются после завершения. Не переключайся на другую вкладку и
            не сворачивай браузер: попытка будет завершена как не сданная.
          </p>
        </div>
      </div>
